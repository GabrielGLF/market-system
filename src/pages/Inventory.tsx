      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 dark:text-white flex items-center gap-2">
            <Package className="w-7 h-7 text-slate-500 dark:text-slate-300" />
                ...
                pageItems(filteredProducts).map(product => {
                    ...
                    return (
                      <tr key={product.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-700/50 transition-colors">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {product.alternativeUnit && (
                                <span className="inline-block mt-0.5 px-1.5 py-0.5 bg-slate-100 dark:bg-slate-700/60 text-slate-500 dark:text-slate-300 dark:text-violet-300 text-[10px] rounded font-medium">
                        ...
                        <td className="px-4 py-3">
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300">
                            {category?.name || 'Geral'}
                          </span>
                        </td>
                        ...
                        <td className="px-4 py-3 text-center font-medium">
                          ...
                          <p className="text-[10px] text-slate-400 mt-0.5">mín: {formatNumber(product.minStock)}</p>
                        </td>
